<?php
//This page is the main front page of the website, seen when the user first clicks on the site.
//It checks to see if the user is logged in, and if so, it sends them to the user index page.
session_start();
		...
		<section id="home" class="welcome-hero">
				        ...
				        <div class="container">
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
				                    ...
				                    <li class="scroll"><a href="#contact">manage vehicles</a></li>
				                    <li><a href="https://localhost/soloproj/login.php">log in</a></li>
			...
			<div class="container">
				<div class="welcome-hero-txt">
					<h2>manage cars with state of the art technology</h2>
					<p>
						Join CarVilla today to have access to state of the art cars and state of the art technology. 
					</p>
					<button class="welcome-btn scrolls" onclick="window.location.href='https://localhost/soloproj/signup.php'">Make an account today!</button>
				</div>
			</div>
								...
								<div class="row">
									...
									<div class="col-md-5 col-sm-12">
										<div class="new-cars-txt">
											...
											<button class="welcome-btn new-cars-btn" onclick="window.location.href='https://localhost/soloproj/login.php'">
												Log in to book!
											</button>
										</div>	
									</div>
